...
const getAllwarehousesId = async (req, res) => {

    try {
        const result = await WarehouseServices.AllWarehouseId(req.query);
...
module.exports = { createWarehouse, getWarehouseById, getAllWarehouses, updateWarehouse, softDeleteWarehouse ,getAllwarehousesId}